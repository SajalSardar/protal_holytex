...
return new class extends Migration {
    ...
    public function up(): void {
        Schema::create('accessories_receiveds', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('accessories_quotation_id')->nullable();
    ...
    public function down(): void {
        Schema::dropIfExists('accessories_receiveds');
    }
};
