...
@section('title', 'Holytex Protal Dashboard')
@section('content')
                            ...
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="my-profile" class="d-flex align-items-center">
                                                <img src="/assets/images/user-11.jpg" class="wh-44 rounded-circle"
                                                    alt="user">
                                                <div class="ms-2">
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-info bg-opacity-10 text-info p-2 fs-12 fw-normal">Confirmed</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="my-profile" class="d-flex align-items-center">
                                                <img src="/assets/images/user-12.jpg" class="wh-44 rounded-circle"
                                                    alt="user">
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="my-profile" class="d-flex align-items-center">
                                                <img src="/assets/images/user-13.jpg" class="wh-44 rounded-circle"
                                                    alt="user">
                                                <div class="ms-2">
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-success bg-opacity-10 text-success p-2 fs-12 fw-normal">In
                                                Progress</span>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center gap-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="my-profile" class="d-flex align-items-center">
                                                <img src="/assets/images/user-14.jpg" class="wh-44 rounded-circle"
                                                    alt="user">
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="my-profile" class="d-flex align-items-center">
                                                <img src="/assets/images/user-15.jpg" class="wh-44 rounded-circle"
                                                    alt="user">
                                                <div class="ms-2">
                                                    <h6 class="fw-medium fs-14">David Brown</h6>
                                                </div>
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-danger bg-opacity-10 text-danger p-2 fs-12 fw-normal">Rejected</span>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center gap-1">
                                                <button
                    ...
                    <ul class="ps-0 mb-0 list-unstyled">
                        <li class="d-flex align-items-center justify-content-between mb-3 pb-3 border-bottom">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <i
                                        class="material-symbols-outlined icon-circle bg-primary bg-opacity-10 text-primary text-center rounded-1 wh-48 lh-48">smartphone</i>
                                </div>
                        ...
                        <li class="d-flex align-items-center justify-content-between mb-3 pb-3 border-bottom">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <i
                                        class="material-symbols-outlined icon-circle bg-primary-div bg-opacity-10 text-primary-div text-center rounded-1 wh-48 lh-48">tap_and_play</i>
                                </div>
                                <div class="flex-grow-1 ms-2">
                        ...
                        <li class="d-flex align-items-center justify-content-between mb-3 pb-3 border-bottom">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <i
                                        class="material-symbols-outlined icon-circle bg-danger bg-opacity-10 text-danger text-center rounded-1 wh-48 lh-48">edgesensor_low</i>
                                </div>
                                <div class="flex-grow-1 ms-2">
                        ...
                        <li class="d-flex align-items-center justify-content-between mb-3 pb-3 border-bottom">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <i
                                        class="material-symbols-outlined icon-circle bg-success bg-opacity-10 text-success text-center rounded-1 wh-48 lh-48">watch</i>
                                </div>
                                <div class="flex-grow-1 ms-2">
                        ...
                        <li class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <i
                                        class="material-symbols-outlined icon-circle bg-info bg-opacity-10 text-info text-center rounded-1 wh-48 lh-48">headphones</i>
                                </div>
                                <div class="flex-grow-1 ms-2">
