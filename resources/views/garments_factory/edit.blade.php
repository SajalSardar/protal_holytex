...
@section('title', 'Edit Garments Factroy')
@section('content')
<div class="main-content-container overflow-hidden">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
        <h2 class="mb-0">Edit Garments Factory</h2>
        ...
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb align-items-center mb-0 lh-1">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    <span class="fw-medium">Edit Garments Factory</span>
                </li>
            </ol>
        </nav>
    </div>
        ...
        <div class=" col-lg-12">
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('settings.garmentsfactroy.update',$garmentsfactroy->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-6 col-sm-6">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        ...
                                        value="{{ old('name',$garmentsfactroy->name) }}">
                                    @error('name')
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="form-group mb-4">
                                    ...
                                    <select name="status"
                                        ...
                                        <option value="active" {{ $garmentsfactroy->status === 'active' ? 'selected' :
                                            ''}}>Active
                                        </option>
                                        <option value="inactive" {{ $garmentsfactroy->status === 'inactive' ? 'selected'
                                            :
                                            ''}}>Inactive</option>
                                    </select>
                                    @error('status')
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="form-group mb-4">
                                    ...
                                    <textarea rows="2" class="form-control @error('address') is-invalid @enderror"
                                        ...
                                        name="address">{{ old('address',$garmentsfactroy->address) }}</textarea>
                                    @error('address')
                                    <div class="text-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="form-group mb-4">
                                    ...
                                    <textarea rows="2" class="form-control @error('description') is-invalid @enderror"
                                        ...
                                        name="description">{{ old('description',$garmentsfactroy->description) }}</textarea>
                                    @error('description')
                                    <div class="text-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
