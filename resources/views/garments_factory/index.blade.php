...
@section('title', 'Garments Factroy')
@section('content')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-1 justify-content-end">
                                                <a href="{{ route('settings.garmentsfactroy.edit',$item->id) }}"
                                                    class="ps-0 border-0 bg-transparent lh-1 position-relative top-2">
                                                    <i class="material-symbols-outlined fs-16 text-body">edit</i>
                                                </a>
                                                <form action="{{ route('settings.garmentsfactroy.destroy',$item->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button" onclick="garmentsDelete(this)"
                                                        class="ps-0 border-0 bg-transparent lh-1 position-relative top-2">
                                                        <i
...
@section('script')
<script>
    function garmentsDelete(element) {
        Swal.fire({
            title: "Are you sure?",
