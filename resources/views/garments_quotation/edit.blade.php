        ...
        <div class=" col-lg-12">
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('nettingreceivedgarments.update',$nettingreceivedgarments->id) }}"
                        method="POST" enctype="multipart/form-data" id="yarn_form">
                        @csrf
                        @method('PUT')
                        <input type="hidden" value="{{ $nettingreceivedgarments->id }}" name="id">
                        <div class="row">
                            <div class="col-lg-4 col-sm-6">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text"
                                        value="{{ old('po_number',$nettingreceivedgarments->po_number) }}"
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="date"
                                        value="{{ old('order_date',$nettingreceivedgarments->order_date) }}"
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="date" class="form-control"
                                        value="{{ old('approximate_delivery_date',$nettingreceivedgarments->approximate_delivery_date) }}"
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-select form-control status_select select2"
                                        ...
                                        <option value="pending" {{ $nettingreceivedgarments->status === "pending" ?
                                            'selected'
                                            :
                                            '' }}>Pending</option>
                                        <option value="approved" {{ $nettingreceivedgarments->status === "approved" ?
                                            'selected' :
                                            '' }}>Approved</option>
                                        <option value="received" {{ $nettingreceivedgarments->status === "received" ?
                                            'selected' :
                                            '' }}>Received</option>
                                        <option value="ready_to_deliver" {{ $nettingreceivedgarments->status ===
                                            "ready_to_deliver" ? 'selected' :
                                            '' }}>Ready to deliver</option>
                                        <option value="delivered" {{ $nettingreceivedgarments->status === "delivered" ?
                                            'selected'
                                            : '' }}>Delivered</option>
                                        <option value="cancelled" {{ $nettingreceivedgarments->status === "cancelled" ?
                                            'selected'
                                            : '' }}>Cancelled</option>
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="form-group mb-4">
                                    ...
                                    <textarea class="form-control" name="remarks"
                                        rows="1">{{ old('remarks',$nettingreceivedgarments->remarks) }}</textarea>
                                </div>
                            </div>
                        </div>
                        <hr>
                            ...
                            <div class="col-lg-3 col-sm-4">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="challan_number" class="form-control"
                                        value="{{ old('challan_number',$nettingreceivedgarments->challan_number)}}">
                                </div>
                            </div>
                            <div class="col-lg-2 col-sm-4">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="vehicle_number" class="form-control"
                                        value="{{ old('vehicle_number',$nettingreceivedgarments->vehicle_number)}}">
                                </div>
                            </div>
                            <div class="col-lg-2 col-sm-4">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="date" name="challan_date" class="form-control"
                                        value="{{ old('challan_date',$nettingreceivedgarments->challan_date)}}">
                                </div>
                            </div>
                            <div class="col-lg-2 col-sm-4">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="date" name="received_date" class="form-control"
                                        value="{{ old('received_date',$nettingreceivedgarments->received_date)}}">
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-4">
                                <div class="form-group mb-4">
                            ...
                            <div class="col-lg-2 col-sm-6 px-0">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class=" form-control"
                                        value="{{ $nettingreceivedgarments->style }}" name="style" readonly>
                            ...
                            <div class="col-lg-2 col-sm-6">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control " placeholder="Description" id="from_stock"
                                        value="{{ @$nettingreceivedgarments->description }}" name="description">
                                </div>
                            </div>
                            <div class="col-lg-2 col-sm-6 pe-0">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="number" class="form-control " placeholder="Quantity" id="unit_quantity"
                                        min="1" name="quantity" value="{{ @$nettingreceivedgarments->quantity }}">
                                </div>
                            </div>
                            <div class="col-lg-2 col-sm-6 pe-0">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="number" class="form-control " min="1" placeholder="Unit Price"
                                        id="unit_price" name="price" value="{{ @$nettingreceivedgarments->price }}">
                                </div>
                            </div>
                            <div class="col-lg-2 col-sm-6 pe-0">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" readonly class="form-control " placeholder="Unit Price"
                                        ...
                                        value="{{ @$nettingreceivedgarments->total_price }}">
                                </div>
                            </div>
                            <div class="col-lg-2 col-sm-6 pe-0">
                                <div class="form-group mb-4">
                                    <label class="label text-secondary">Germents Factory</label>
                                    <select name="garments_factory_id" class="form-control select2">
                                        <option value="" selected disabled>Select Factory</option>
                                        @foreach ($garmentsFactroy as $item)
                                        <option value="{{ $item->id }}" {{$nettingreceivedgarments->garments_factory_id
                                            ===
                                            $item->id
