...
<div class="main-content-container overflow-hidden">
    ...
    <form action="{{ route('nettingstorestock.store') }}" method="POST" enctype="multipart/form-data" id="yarn_form">
        @csrf
        <div class="row">
            <div class="col-lg-12">
...
<script>
                                    ...
                                    if(allTotalRecevied >= quotation){ 
                                        ...
                                        singleItem +=`<div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3 pe-0 mb-3"><label class="label text-secondary">Store Address</label><textarea rows="1" class="form-control" name="items[${item.id}][store_address]"></textarea></div>
    ...
    function limitWeightValue(input, id){
        ...
        let totalVal = (Number(netting_) || 0);
