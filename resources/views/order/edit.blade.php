...
<script>
    ...
    function addToTable() {
        ...
        // Update existing row
            ...
            editingRow.cells[2].innerHTML = `${parseFloat(unit_quantity.value).toFixed(2)} <input type="hidden" value="${parseFloat(unit_quantity.value).toFixed(2)}" name="unit_quantity[]">`;
            editingRow.cells[3].innerHTML = `${parseFloat(unit_price.value).toFixed(2)} <input type="hidden" value="${parseFloat(unit_price.value).toFixed(2)}" name="unit_price[]">`;
            ...
            row.innerHTML = `
                ...
                <td>${parseFloat(unit_quantity.value).toFixed(2)} <input type="hidden" value="${parseFloat(unit_quantity.value).toFixed(2)}" name="unit_quantity[]"></td>
                <td>${parseFloat(unit_price.value).toFixed(2)} <input type="hidden" value="${parseFloat(unit_price.value).toFixed(2)}" name="unit_price[]"></td>
