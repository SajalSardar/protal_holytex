...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('details-view/{po_number}/{style}/{description}', [YarnReceivedController::class, 'detailsView'])->name('yarnreceived.detail.view')->where('description', '.*');
    Route::get('get-yarn-quotation-by-po/{po_number}', [YarnReceivedController::class, 'getYarnStyleByPo']);
    Route::get('distribute-yarn/{po_number}/{style}/{description}', [YarnReceivedController::class, 'yarnDistribute'])->name('yarnreceived.distribute')->where('description', '.*');
